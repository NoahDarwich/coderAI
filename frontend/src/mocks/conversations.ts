...
export const mockGeneratedSchema: SchemaVariable[] = [
  {
    ...
    name: 'protest_date',
    type: 'DATE',
    instructions: 'The date when the protest occurred',
  ...
  },
  {
    ...
    name: 'city',
    type: 'LOCATION',
    instructions: 'The city where the protest took place',
  ...
  },
  {
    ...
    name: 'country',
    type: 'LOCATION',
    instructions: 'The country where the protest took place',
  ...
  },
  {
    ...
    type: 'NUMBER',
    instructions: 'Estimated number of participants in the protest',
  ...
  },
  {
    ...
    name: 'protest_topic',
    type: 'CATEGORY',
    instructions: 'The main topic of the protest',
  ...
  },
  {
    ...
    type: 'BOOLEAN',
    instructions: 'Whether violence occurred during the protest (physical confrontation or property damage)',
  ...
  },
  {
    ...
    type: 'CATEGORY',
    instructions: 'The level of police response to the protest',
